...
class AuthApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetApiAuthMe200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetApiAuthMe200Response>> getApiAuthMe({ 
    ...
    return Response<GetApiAuthMe200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PostApiAuthLogin200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PostApiAuthLogin200Response>> postApiAuthLogin({ 
    required PostApiAuthLoginRequest postApiAuthLoginRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    return Response<PostApiAuthLogin200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PostApiAuthLogout200Response>> postApiAuthLogout({ 
    required PostApiAuthLogoutRequest postApiAuthLogoutRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PostApiAuthRefresh200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PostApiAuthRefresh200Response>> postApiAuthRefresh({ 
    required PostApiAuthLogoutRequest postApiAuthLogoutRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    return Response<PostApiAuthRefresh200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [PostApiAuthRefresh200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PostApiAuthRefresh200Response>> postApiAuthRegister({ 
    required PostApiAuthRegisterRequest postApiAuthRegisterRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
