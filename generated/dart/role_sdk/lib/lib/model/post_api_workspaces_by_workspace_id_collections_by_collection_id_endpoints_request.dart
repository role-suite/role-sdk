...
class PostApiWorkspacesByWorkspaceIdCollectionsByCollectionIdEndpointsRequest {
  /// Returns a new [PostApiWorkspacesByWorkspaceIdCollectionsByCollectionIdEndpointsRequest] instance.
  ...
  final PostApiWorkspacesByWorkspaceIdCollectionsByCollectionIdEndpointsRequestMethodEnum method;
  ...
  final String url;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is PostApiWorkspacesByWorkspaceIdCollectionsByCollectionIdEndpointsRequest &&
      other.auth == auth &&
      other.body == body &&
  ...
  factory PostApiWorkspacesByWorkspaceIdCollectionsByCollectionIdEndpointsRequest.fromJson(Map<String, dynamic> json) => _$PostApiWorkspacesByWorkspaceIdCollectionsByCollectionIdEndpointsRequestFromJson(json);

  Map<String, dynamic> toJson() => _$PostApiWorkspacesByWorkspaceIdCollectionsByCollectionIdEndpointsRequestToJson(this);
...
enum PostApiWorkspacesByWorkspaceIdCollectionsByCollectionIdEndpointsRequestMethodEnum {
  @JsonValue(r'GET')
  GET,
  @JsonValue(r'POST')
  POST,
