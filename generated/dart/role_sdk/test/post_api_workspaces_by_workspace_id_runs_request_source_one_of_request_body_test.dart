...
// tests for PostApiWorkspacesByWorkspaceIdRunsRequestSourceOneOfRequestBody
void main() {
  final instance = PostApiWorkspacesByWorkspaceIdRunsRequestSourceOneOfRequestBodyBuilder();
  // TODO add properties to the builder and call build()

  group(PostApiWorkspacesByWorkspaceIdRunsRequestSourceOneOfRequestBody, () {
    // String contentType
